namespace UserMng.Web.Common.MessageBox
{
    public class msgBox : ImsgBox
    {
        ...
        public JsResult GotoPanelMsg(string message, string CallBackFuncs = null)
        {
           
            return new JsResult(Show("", message, MsgBoxType.success, "برو به پنل کاربری من", CallBackFuncs));
